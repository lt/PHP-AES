...
class CTR128 extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $ctr = new CTR(new Key(hex2bin('2b7e151628aed2a6abf7158809cf4f3c')), hex2bin('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff'));
    ...
    {
        $ctr = new CTR(new Key(hex2bin('2b7e151628aed2a6abf7158809cf4f3c')), hex2bin('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff'));
        $result = $ctr->decrypt(hex2bin('874d6191b620e3261bef6864990db6ce9806f66b7970fdff8617187bb9fffdff5ae4df3edbd5d35e5b4f09020db03eab1e031dda2fbe03d1792170a0f3009cee'));
