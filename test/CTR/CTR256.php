...
class CTR256 extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $ctx = new Context(hex2bin('603deb1015ca71be2b73aef0857d77811f352c073b6108d72d9810a30914dff4'), hex2bin('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff'));
        $cbc = new CTR();
    ...
    function testDecrypt()
    {
        $ctx = new Context(hex2bin('603deb1015ca71be2b73aef0857d77811f352c073b6108d72d9810a30914dff4'), hex2bin('f0f1f2f3f4f5f6f7f8f9fafbfcfdfeff'));
        $cbc = new CTR();
        $result = $cbc->decrypt($ctx, hex2bin('601ec313775789a5b7a7f504bbf3d228f443e3ca4d62b59aca84e990cacaf5c52b0930daa23de94ce87017ba2d84988ddfc9c58db67aada613c2dd08457941a6'));
